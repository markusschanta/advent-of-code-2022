...
def generate_day_tile_image(day: str, year: str, languages: list[str], day_scores: Union[DayScores, None] ) -> Path:
...
def handle_day(day: int, year: int, solutions: list[str], html: HTML, day_scores: Union[DayScores, None]):
    languages = []
